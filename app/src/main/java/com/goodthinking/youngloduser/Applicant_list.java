        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data : dataSnapshot.getChildren()) {
                    //User youngloduser=new User(Usernamestr, UserPhonestr, UserEmailstr,NoOfParticipators);
                    User user = data.getValue(User.class);
                    //System.out.println("participants"+youngloduser.getUserNoOfParticipators());
                    //System.out.println("password" + youngloduser.getUserPassword());
                    amountOfApplicants +=  user.getUserNoOfParticipators();
                    applicant_list_adapter.getApplicantList().add(user);

                  //  System.out.println("amount" + youngloduser.getUserNoOfParticipators());
