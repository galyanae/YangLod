...
// Specify the layout to use when the list of choices appears
    ...
    public void save(View view) {
        String Hname = ((EditText) findViewById(R.id.HogName)).getText().toString();
        String Details = ((EditText) findViewById(R.id.editDetails2)).getText().toString();
        String LecturerName = ((EditText) findViewById(R.id.editLecturer)).getText().toString();
        String ParticipantsNum = ((EditText) findViewById(R.id.editParticipantNumber)).getText().toString();

        int pos = audienceSpinner.getSelectedItemPosition();
        String audience = (String) audienceAdapter.getItem(pos);
        pos = spinner.getSelectedItemPosition();
        String lang = (String) adapter.getItem(pos);
        String hogCost = ((EditText) findViewById(R.id.editCost)).getText().toString();


        String Sdate = CourseStartdate;
        String Edate = CourseEndDate;
        Boolean show = true;
        int img = R.drawable.hide;

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("Tables");
//public Course(String name, String date, String hour, String gide, String details, String key, String endDate, String numberPrticipate, String cost, String aduience, String lang, boolean show, int hogImg) {

        myRef.child("hogim").push().setValue(new Course(Hname, Sdate, startTime, LecturerName, Details, key, Edate, ParticipantsNum, hogCost, audience, lang, show, img),
